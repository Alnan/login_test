...
SECRET_KEY = 'jln#!gf!0pc&^l+lk9l4d1hd9zppf78n$z*2bq+s7bi%8m*mb5'
...
# 使用Django自带login_required,需配置登录路由
LOGIN_URL="/login/"

AUTH_USER_MODEL = 'crm.UserProfile'

CRM_FILE_UPLOAD_DIR = os.path.join(BASE_DIR,'crm/upload_files/enrollment_data')
CRM_FILE_HOMEWORK_DIR = os.path.join(BASE_DIR,'crm/upload_files/homework_data')
